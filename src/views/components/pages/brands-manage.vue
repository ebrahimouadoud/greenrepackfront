<template>
    <div>
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3">
                <div id="example_filter" class="dataTables_filter">
                    <button type="button" @click="addingBrand = true" class="btn btn-secondary">
                        <ThemifyIcon icon="plus" />  Nouvelle marque
                    </button>
                </div>
            </div>
        </div>
        ...
        <vs-popup title="Ajouter une nouvelle marque" :active.sync="addingBrand">
            <vs-alert  title="Commande a envoyer" active="true" color="warning" class="mb-3">
                Renseignez le nom de la marque
            </vs-alert>
            <vs-input :danger="$v.newBrandName.$error"  class="inputx mb-4 col-11" placeholder="Nom de la marque" v-model="newBrandName"/>
            <vs-button @click="saveBrand()" color="success" icon="save" type="filled">
                Envoyer
            </vs-button>
        </vs-popup>
    </div>
